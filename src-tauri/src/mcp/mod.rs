...
// 使用 once_cell 替代 lazy_static，或者直接用函数返回
...
pub async fn call_mcp_tool(_server_name: &str, _tool_name: &str, _arguments: serde_json::Value) -> Result<serde_json::Value> {
